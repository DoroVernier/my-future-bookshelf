    ...
    xhr.send(
      ...
      #docs-root[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./components","files":"**/*.stories.js","importPathMatcher":"^\\.[\\\\/](?:components(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.js)$"}];
          
      
          
            window['SERVER_CHANNEL_URL'] = "ws://localhost:6006/storybook-server-channel";</script><script src="runtime~main.iframe.bundle.js"></script><script src="vendors-node_modules_storybook_addon-actions_preview_js-generated-config-entry_js-node_module-ebb59c.iframe.bundle.js"></script><script src="main.iframe.bundle.js"></script></body></html>